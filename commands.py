from voice import speak ,stop_ai
import system
...
def process(command):
    ...
    if "hello assistant" in command:
        ai_mode = True
        speak("AI chat mode activated. I am listening.")
        return True

    # =========================
    # STOP AI CHAT MODE
    # =========================
    elif "thank you assistant" in command or "exit assistant" in command:
        ai_mode = False
        speak("AI chat mode stopped. Back to normal mode.")
        return True
    ...
    # =========================
        ...
        system.volume_up()
        speak("Sure, turning the volume up.")

    elif "volume down" in command:
        system.volume_down()
        speak("I turned the sound down.")
    ...
    # ==========================================
        ...
        human_ai.human_ai.acknowledge_command(command)
        human_ai.human_ai.human_speak("Let me read your screen...")
        text = vision_ai.read_screen()
        print(text)
        human_ai.human_ai.human_speak("Okay, I've extracted the text from your screen!")
